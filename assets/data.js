export const Users = [
  ...
  {
    title: '知识点阐述',
    description: '我给你一个词，你会围绕这个词构建一个知识世界，你是这个知识世界的导游，你会用导游的语气，导游的风格向我介绍这个知识世界，在其中知识以象征的形式出现，将象征进行联想，将联想构建成网，将网构建成游戏，现在开始',
    descn: '我给你一个词，你会围绕这个词构建一个知识世界，你是这个知识世界的导游，你会用导游的语气，导游的风格向我介绍这个知识世界，在其中知识以象征的形式出现，将象征进行联想，将联想构建成网，将网构建成游戏，现在开始',
    remark: '适合用于教育和知识普及。反馈结果包含两部分：知识点解释和关联概念；知识点小游戏。将知识象征化，更符合人类大脑的记忆原理，方便记忆。来自 @ergf991 的投稿。',
    preview: null,
    website: null,
    source: null,
    tags: ['contribute','mind'],
